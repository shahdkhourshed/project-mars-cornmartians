...
const LettucePage = () => {
  ...
  const lettuceData = data.find((model) => model.category === 'lettuce');
  const details = lettuceData.details;
  ...
  const LettuceDetails = () => (
    <div className="text-white p-8">
      <h2 className="text-2xl font-bold mb-4">Lettuce Details</h2>
